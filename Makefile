...
eval2:
	$(PYTHON_INTERPRETER) setup.py install
	CUDA_VISIBLE_DEVICES=$(CUDA_NUM) $(PYTHON_INTERPRETER) src/ddpm_eval_L.py --path=$(path) --config=$(config)
...
get_started:
	@echo ""
	@echo ">>> Please enter the GPU node (by running '02514sh')."
	@echo ">>> Then please ACTIVATE your conda environment!"
	@echo ">>> Now you can see your options by running 'make help'"
	@echo ""
