...
def get_dataloaders(batch_size, num_workers=8):
    ...
    trainloader = DataLoader(
        trainset, batch_size=batch_size, num_workers=num_workers, shuffle=False#True
    )
    valloader = DataLoader(valset_new, batch_size=batch_size, num_workers=num_workers)
    testloader = DataLoader(testset_new2, batch_size=batch_size, num_workers=num_workers)
