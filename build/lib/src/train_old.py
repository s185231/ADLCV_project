...
from ADLCV_project.src.ddpm_old import Diffusion
...
def train(device='cpu', T=100, img_size=64, input_channels=3, channels=32, time_dim=128,
          batch_size=4, lr=1e-3, num_epochs=30, experiment_name="ddpm", show=False):
